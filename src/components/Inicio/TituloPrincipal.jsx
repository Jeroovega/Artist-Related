...
const TituloPrincipal = () => {
  ...
  return (
    <div className="">
      ...
      <p className="text-xl text-center font-Titulo text-black/60">¡Encontrá artistas similares a tus favoritos. Ampliá tu repetorio musical hallando esa misma esencia en sus canciones!</p>
    </div>
  )
}
